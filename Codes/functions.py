...
'coral':'&color_id[]=22', 'red':'&color_id[]=7','claret(bordeaux)':'&color_id[]=23','pink':'&color_id[]=5',\
'light pink':'&color_id[]=24', 'purple':'&color_id[]=6', 'lila':'&color_id[]=25', 'light blue':'&color_id[]=26',\
...
def collect_info(page_url):
    ...
    Nombre d’intéressés, Nombre d’étoiles, Nombre d’avis, catégorie'''
    driver.get(page_url)
    #time.sleep(4)
